...
<body class="create-page-body">
    ...
    <main class="create-container">
        <div class="back-link">
            <button onclick='window.location.href="<?php echo e(url("/mainpage")); ?>"'>
                &larr; Back
            </button>
        </div>

        <form class="recipe-form" action="<?php echo e(url('/submit_recipe')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php /**PATH D:\Tugas\Secpro\SecPro\FrontEndSec\resources\views/createPage.blade.php ENDPATH**/ ?>