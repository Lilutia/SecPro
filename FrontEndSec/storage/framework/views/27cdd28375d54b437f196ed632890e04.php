...
<body class="detail-page-body">
    ...
    <header class="navbar">
        ...
        <div class="right-side">
            ...
            <button class="profile-btn" onclick='window.location.href="<?php echo e(url("/profile")); ?>"'>
    ...
    <main class="recipe-detail-container">
        <div class="image-column">
            <img src="<?php echo e(asset('foto/soy_fried_chicken.jpg')); ?>" alt="Fried Chicken" class="recipe-image">
...
<?php /**PATH D:\Tugas\Secpro\SecPro\FrontEndSec\resources\views/detailResep.blade.php ENDPATH**/ ?>